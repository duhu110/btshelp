...
public class BtsinfoServiceImpl implements BtsinfoService {

	@Override
	public List<String> getbtsinfolist(int btsid) throws Exception {
		List<String> list =new ArrayList<String>();
		HttpClient client = new DefaultHttpClient();
		String uri = "http://duhu110.oicp.net/BTSHelper/GetBtsinfolist.do";
	...
	public void savebtsinfolist(List<String> list,int btsid) throws Exception {
		HttpClient client = new DefaultHttpClient();
		String uri = "http://duhu110.oicp.net/BTSHelper/SaveBtsInfo.do";
		HttpPost post = new HttpPost(uri);
		JSONObject object = new JSONObject();
